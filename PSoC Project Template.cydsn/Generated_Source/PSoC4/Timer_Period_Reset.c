...
{
   #if(Timer_Period_Reset_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(Timer_Period_Reset_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(Timer_Period_Reset_PERIOD_LSB_PTR));
   #endif /* (Timer_Period_Reset_UsingFixedFunction) */
}
...
void Timer_Period_Reset_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(Timer_Period_Reset_PERIOD_LSB_PTR, period);
...
{
   #if(Timer_Period_Reset_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(Timer_Period_Reset_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(Timer_Period_Reset_CAPTURE_LSB_PTR));
   #endif /* (Timer_Period_Reset_UsingFixedFunction) */
}
...
void Timer_Period_Reset_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(Timer_Period_Reset_COUNTER_LSB_PTR, counter);
